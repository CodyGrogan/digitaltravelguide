...
let museum = new Question('history', 'historical sites and museums');
...
let garden = new Question('nature', 'gardens and parks');
...
let questionObjArr = [chinese, museum, spicy, gallery, sushi, tall, garden, artsandcrafts, nightlife, shopping, hiking];
