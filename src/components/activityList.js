...
let palacemuseum =  new Activity('Palace Museum', 'Shilin District', img, "Natural History Museum and Art gallery", "Houses China's imperial treasures", 'history', 25.04208334099123, 121.55513450556618, false);


let fakeramen =  new Activity('Fake Ramen Place', 'Everywhere', img, "Popular ramen chain", "Cheap, good and fast. Conveyor belt ramen perfect for a quick lunch", 'japanese', 25.03586754133035, 121.5483244857638, true);
let fakedumpling =  new Activity('Fake Dumpling Place', 'Everywhere', img, "Popular dumpling chain", "Cheap, good and fast. Conveyor belt ramen perfect for a quick lunch", 'chinese', 25.03186754133035, 121.5283244857638, true);

let activityList = [Taipei101,DingTaiFeng,sushiexpress,sys,taiwanMuseum, fakeramen, fakedumpling, palacemuseum];
